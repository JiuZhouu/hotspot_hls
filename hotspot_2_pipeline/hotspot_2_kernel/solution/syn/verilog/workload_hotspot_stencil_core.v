...
workload_fadd_32ns_32ns_32_7_full_dsp_0 #(
    .ID( 1 ),
    .NUM_STAGE( 7 ),
    .din0_WIDTH( 32 ),
    .din1_WIDTH( 32 ),
    .dout_WIDTH( 32 ))
fadd_32ns_32ns_32_7_full_dsp_0_U1(
    .clk(ap_clk),
    .reset(ap_rst),
...
workload_fadd_32ns_32ns_32_7_full_dsp_0 #(
    ...
    .din1_WIDTH( 32 ),
    .dout_WIDTH( 32 ))
fadd_32ns_32ns_32_7_full_dsp_0_U2(
    .clk(ap_clk),
    .reset(ap_rst),
...
workload_fadd_32ns_32ns_32_7_full_dsp_0 #(
    ...
    .din1_WIDTH( 32 ),
    .dout_WIDTH( 32 ))
fadd_32ns_32ns_32_7_full_dsp_0_U3(
    .clk(ap_clk),
    .reset(ap_rst),
...
workload_fsub_32ns_32ns_32_7_full_dsp_0 #(
    .ID( 1 ),
    .NUM_STAGE( 7 ),
    .din0_WIDTH( 32 ),
    .din1_WIDTH( 32 ),
    .dout_WIDTH( 32 ))
fsub_32ns_32ns_32_7_full_dsp_0_U4(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(add1_reg_164),
    .din1(tmp_reg_158),
...
workload_fmul_32ns_32ns_32_4_max_dsp_0 #(
    .ID( 1 ),
    .NUM_STAGE( 4 ),
    .din0_WIDTH( 32 ),
    .din1_WIDTH( 32 ),
...
workload_fmul_32ns_32ns_32_4_max_dsp_0 #(
    ...
    .din1_WIDTH( 32 ),
    .dout_WIDTH( 32 ))
fmul_32ns_32ns_32_4_max_dsp_0_U12(
    .clk(ap_clk),
    .reset(ap_rst),
...
workload_fmul_32ns_32ns_32_4_max_dsp_0 #(
    ...
    .din1_WIDTH( 32 ),
    .dout_WIDTH( 32 ))
fmul_32ns_32ns_32_4_max_dsp_0_U13(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(tmp2_reg_199),
    .din1(32'd961334477),
