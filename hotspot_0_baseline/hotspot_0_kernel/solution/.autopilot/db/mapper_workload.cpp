...
extern "C" void workload(__cosim_s40__*, int, int, int);
extern "C" void apatb_workload_hw(volatile void * __xlx_apatb_param_result, volatile void * __xlx_apatb_param_temp, volatile void * __xlx_apatb_param_power) {
  // Collect __xlx_result_temp_power__tmp_vec
  vector<sc_bv<512> >__xlx_result_temp_power__tmp_vec;
  for (int j = 0, e = 16384; j != e; ++j) {
    ...
    __xlx_result_temp_power__tmp_vec.push_back(_xlx_tmp_sc);
  }
  ...
  int __xlx_offset_param_temp = 16384;
  int __xlx_offset_byte_param_temp = 16384*64;
  for (int j = 0, e = 16384; j != e; ++j) {
    sc_bv<512> _xlx_tmp_sc;
  ...
  int __xlx_offset_param_power = 32768;
  int __xlx_offset_byte_param_power = 32768*64;
  __cosim_s40__* __xlx_result_temp_power__input_buffer= new __cosim_s40__[__xlx_result_temp_power__tmp_vec.size()];
  for (int i = 0; i < __xlx_result_temp_power__tmp_vec.size(); ++i) {
    ((long long*)__xlx_result_temp_power__input_buffer)[i*8+0] = __xlx_result_temp_power__tmp_vec[i].range(63, 0).to_uint64();
    ((long long*)__xlx_result_temp_power__input_buffer)[i*8+1] = __xlx_result_temp_power__tmp_vec[i].range(127, 64).to_uint64();
    ((long long*)__xlx_result_temp_power__input_buffer)[i*8+2] = __xlx_result_temp_power__tmp_vec[i].range(191, 128).to_uint64();
    ((long long*)__xlx_result_temp_power__input_buffer)[i*8+3] = __xlx_result_temp_power__tmp_vec[i].range(255, 192).to_uint64();
    ((long long*)__xlx_result_temp_power__input_buffer)[i*8+4] = __xlx_result_temp_power__tmp_vec[i].range(319, 256).to_uint64();
    ((long long*)__xlx_result_temp_power__input_buffer)[i*8+5] = __xlx_result_temp_power__tmp_vec[i].range(383, 320).to_uint64();
    ((long long*)__xlx_result_temp_power__input_buffer)[i*8+6] = __xlx_result_temp_power__tmp_vec[i].range(447, 384).to_uint64();
    ((long long*)__xlx_result_temp_power__input_buffer)[i*8+7] = __xlx_result_temp_power__tmp_vec[i].range(511, 448).to_uint64();
  }
  // DUT call
  workload(__xlx_result_temp_power__input_buffer, __xlx_offset_byte_param_result, __xlx_offset_byte_param_temp, __xlx_offset_byte_param_power);
// print __xlx_apatb_param_result
  ...
  for (int i = 0; i < __xlx_size_param_result; ++i) {
    char* start = (char*)(&(__xlx_result_temp_power__input_buffer[__xlx_offset_param_result]));
...
// print __xlx_apatb_param_temp
  ...
  for (int i = 0; i < __xlx_size_param_temp; ++i) {
    char* start = (char*)(&(__xlx_result_temp_power__input_buffer[__xlx_offset_param_temp]));
...
// print __xlx_apatb_param_power
  ...
  for (int i = 0; i < __xlx_size_param_power; ++i) {
    char* start = (char*)(&(__xlx_result_temp_power__input_buffer[__xlx_offset_param_power]));
